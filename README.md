...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pystitcher-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13393&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pystitcher-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pystitcher` can be installed with:

```
conda install pystitcher
```

It is possible to list all of the versions of `pystitcher` available on your platform with:
